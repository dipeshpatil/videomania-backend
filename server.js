...
app.use('/transaction', [applyRateLimiter(rateLimiter.transaction)], transactionRoute);
...
app.listen(port, function () {
  ...
  console.log(`Expired Links Set To Delete Every: ${expiredLinkFrequencyMinutes} Minutes`);
});
