...
const {
  planDetails,
  planPriorityMapping,
  planPurchaseErrorCodes: { SAME_PLAN_ERROR, TIER_PLAN_ERROR, PLAN_PURCHASE_GOAHEAD },
} = require('../enums/video');
...
const { adjustUserPlan, logBlacklistedToken, getUserExistingPlan } = require('../utils/mongo');
...
class PlanPurchaseController {
  ...
  async #checkExistingPlan(userPlanDetails) {
    ...
    const upgradedPlanPriority = planPriorityMapping[upgradedPlan.toUpperCase()];
